...
route = [
    ...
    (  1.8,   3.1, mph(79), True),
                                # 35TH STREET stop
    (  3.1,   3.7, mph(79), False),
    (  3.7,   7.5, mph(79), False),
    (  7.5,   8.8, mph(79), True),
                                # AUBURN PARK stop
    (  8.8,   9.8, mph(79), True),
                                # GRESHAM stop
