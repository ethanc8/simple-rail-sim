...
scenario_name = "Metra Electric [infill 90mph] - Kankakee Express"
...
route = [
    ...
    (  4.82*mi,    5.90*mi, 90*mi/h, False, dwell_time),
                                # 47TH STREET stop
    (  5.90*mi,    6.54*mi, 90*mi/h, False, dwell_time),
                                # 53RD STREET stop
    (  6.54*mi,    6.99*mi, 90*mi/h, True, dwell_time),
                                # 57TH STREET stop
    (  6.99*mi,    7.43*mi, 90*mi/h, False, dwell_time),
                                # 59TH STREET stop
    ...
    ( 14.49*mi,   17.33*mi, 90*mi/h, False, long_dwell),
                                # RIVERDALE stop
    ( 17.33*mi,   18.18*mi, 90*mi/h, False, dwell_time),
                                # IVANHOE stop
    ( 18.18*mi,   18.98*mi, 90*mi/h, False, dwell_time),
                                # 147TH STREET stop
    ( 18.98*mi,   20.00*mi, 90*mi/h, True, dwell_time),
                                # HARVEY stop
    ( 20.00*mi,   22.27*mi, 90*mi/h, False, dwell_time),
                                # HAZEL CREST stop
    ( 22.27*mi,   22.82*mi, 90*mi/h, False, dwell_time),
                                # CALUMET stop
    ( 22.82*mi,   23.51*mi, 90*mi/h, True, dwell_time),
                                # HOMEWOOD stop
    ( 23.51*mi,   24.93*mi, 90*mi/h, False, dwell_time),
                                # FLOSSMOOR stop
    ( 24.93*mi,   26.56*mi, 90*mi/h, False, dwell_time),
                                # OLYMPIA FIELDS stop
    ( 26.56*mi,   27.62*mi, 90*mi/h, False, dwell_time),
                                # 211TH STREET stop
    ( 27.62*mi,   28.24*mi, 90*mi/h, False, dwell_time),
                                # MATTESON stop
    ( 28.24*mi,   29.33*mi, 90*mi/h, True, dwell_time),
                                # RICHTON PARK stop
    ( 29.33*mi,   31.50*mi, 90*mi/h, True, dwell_time),
                                # UNIVERSITY PARK stop
    ( 31.50*mi,   34.20*mi, 90*mi/h, True, dwell_time),
                                # MONEE stop
    ( 34.20*mi,   40.50*mi, 90*mi/h, True, dwell_time),
                                # PEOTONE stop
    ( 40.50*mi,   46.70*mi, 90*mi/h, True, dwell_time),
                                # MANTENO stop
    ( 46.70*mi,   52.80*mi, 90*mi/h, True, dwell_time),
                                # BOURBONNAIS stop
    ( 52.80*mi,   54.20*mi, 90*mi/h, True, dwell_time),
                                # BRADLEY stop
    ( 54.20*mi,   55.90*mi, 90*mi/h, True, dwell_time),
                                # KANKAKEE stop
]
