...
route = [
    ...
    (  1.8*mi,    3.1*mi, 79*mi/h, True, dwell_time),
                                # 35TH STREET stop
    (  3.1*mi,    3.7*mi, 79*mi/h, False, dwell_time),
    (  3.7*mi,    7.5*mi, 79*mi/h, False, dwell_time),
    ...
    (  9.9*mi,   10.6*mi, 79*mi/h, True, dwell_time),
                                # BRAINERD stop
    ( 10.6*mi,   11.3*mi, 79*mi/h, True, dwell_time),
                                # BEVERLY HILLS-91ST STREET stop
    ( 11.3*mi,   11.7*mi, 79*mi/h, True, dwell_time),
                                # BEVERLY HILLS-95TH STREET stop
    ( 11.7*mi,   12.3*mi, 79*mi/h, True, dwell_time),
                                # BEVERLY HILLS-99TH STREET stop
    ( 12.3*mi,   12.8*mi, 79*mi/h, True, dwell_time),
                                # BEVERLY HILLS-103RD STREET stop
    ( 12.8*mi,   13.3*mi, 79*mi/h, True, dwell_time),
                                # BEVERLY HILLS-107TH STREET stop
    ( 13.3*mi,   13.8*mi, 79*mi/h, True, dwell_time),
                                # MORGAN PARK-111TH STREET stop
    ( 13.8*mi,   14.3*mi, 79*mi/h, True, dwell_time),
                                # MORGAN PARK-115TH STREET stop
    ( 14.3*mi,   14.8*mi, 79*mi/h, True, dwell_time),
                                # BLUE ISLAND-119TH STREET stop
    ( 14.8*mi,   15.2*mi, 79*mi/h, True, dwell_time),
                                # BLUE ISLAND-123RD STREET stop
    ( 15.2*mi,   15.9*mi, 79*mi/h, True, dwell_time),
                                # BLUE ISLAND-PRAIRIE STREET stop
    ( 15.9*mi,   16.4*mi, 79*mi/h, True, dwell_time),
