scenario_name = "Metra Electric - Main Line (90mph)"
...
route = [
    ...
    (  2.68*mi,    3.20*mi, 90*mi/h, True, dwell_time),
                                # 27TH STREET stop
    (  3.20*mi,    5.90*mi, 90*mi/h, True, dwell_time),
                                # 47TH STREET stop
    ...
    (  6.99*mi,    7.43*mi, 90*mi/h, True, dwell_time),
                                # 59TH STREET stop
    (  7.43*mi,    7.92*mi, 90*mi/h, True, dwell_time),
                                # 63RD STREET stop
    (  7.92*mi,    8.33*mi, 90*mi/h, True, dwell_time),
                                # 67TH STREET stop
    (  8.33*mi,    9.32*mi, 90*mi/h, True, dwell_time),
                                # 75TH-GRAND CROSSING stop
    (  9.32*mi,    9.99*mi, 90*mi/h, True, dwell_time),
                                # 79TH-CHATHAM stop
    (  9.99*mi,   10.38*mi, 90*mi/h, True, dwell_time),
                                # 83RD-AVALON PARK stop
    ( 10.38*mi,   10.86*mi, 90*mi/h, True, dwell_time),
                                # 87TH-WOODRUFF stop
    ( 10.86*mi,   11.37*mi, 90*mi/h, True, dwell_time),
                                # 91ST-CHESTERFIELD stop
    ( 11.37*mi,   12.04*mi, 90*mi/h, True, dwell_time),
                                # 95TH-CHICAGO STATE UNIVERSITY stop
    ( 12.04*mi,   13.06*mi, 90*mi/h, True, dwell_time),
                                # 103RD STREET stop
    ( 13.06*mi,   13.54*mi, 90*mi/h, True, dwell_time),
                                # 107TH STREET stop
    ( 13.54*mi,   13.95*mi, 90*mi/h, True, dwell_time),
                                # 111TH-PULLMAN stop
    ( 13.95*mi,   14.49*mi, 90*mi/h, True, dwell_time),
                                # 115TH-KENSINGTON stop
    ( 14.49*mi,   17.33*mi, 90*mi/h, True, dwell_time),
                                # RIVERDALE stop
