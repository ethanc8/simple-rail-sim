...
route = [
    ...
    (  1.43,   2.22, mph(90), True),
                                # 18TH STREET stop
    (  2.22,   2.68, mph(90), True),
                                # MCCORMICK PLACE/23RD STREET stop
    (  2.68,   3.20, mph(90), True),
                                # 27TH STREET stop
    (  3.20,   5.90, mph(90), True),
                                # 47TH STREET stop
    (  5.90,   6.54, mph(90), True),
                                # 53RD STREET stop
    (  6.54,   6.99, mph(90), True),
                                # 57TH STREET stop
    (  6.99,   7.43, mph(90), True),
                                # 59TH STREET stop
    (  7.43,   7.92, mph(90), True),
                                # 63RD STREET stop
    (  7.92,   8.33, mph(90), True),
                                # 67TH STREET stop
    (  8.33,   9.32, mph(90), True),
                                # 75TH-GRAND CROSSING stop
    (  9.32,   9.99, mph(90), True),
                                # 79TH-CHATHAM stop
    (  9.99,  10.38, mph(90), True),
                                # 83RD-AVALON PARK stop
    ( 10.38,  10.86, mph(90), True),
                                # 87TH-WOODRUFF stop
    ( 10.86,  11.37, mph(90), True),
                                # 91ST-CHESTERFIELD stop
    ( 11.37,  12.04, mph(90), True),
                                # 95TH-CHICAGO STATE UNIVERSITY stop
    ( 12.04,  13.06, mph(90), True),
                                # 103RD STREET stop
    ( 13.06,  13.54, mph(90), True),
                                # 107TH STREET stop
    ( 13.54,  13.95, mph(90), True),
                                # 111TH-PULLMAN stop
    ( 13.95,  14.49, mph(90), True),
