...
route = [
    ...
    ( 17.0*mi,   47.9*mi, 300*km/h, False, dwell_time),
    ( 47.9*mi,   48.4*mi, 280*km/h, False, dwell_time), # Manteno curve
    ( 48.4*mi,   55.9*mi, 300*km/h, True, dwell_time),
                                # KANKAKEE stop
    ( 55.9*mi,   67.4*mi, 300*km/h, False, dwell_time), # 5100 N Rd grade crossing, Clifton
    ( 67.4, 127.8, 177, True ), 
                                # CHAMPAIGN stop
