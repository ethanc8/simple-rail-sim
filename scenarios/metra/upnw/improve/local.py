...
route = [
    ...
    (  3.5*mi,    7.6*mi, 110*mi/h, True, dwell_time),
                                # MAYFAIR stop
    (  7.6*mi,    9.7*mi, 110*mi/h, True, dwell_time),
                                # GLADSTONE PARK stop
    (  9.7*mi,   11.1*mi, 110*mi/h, True, dwell_time),
                                # NORWOOD PARK stop
    ( 11.1*mi,   12.3*mi, 110*mi/h, True, dwell_time),
                                # EDISON PARK stop
    ( 12.3*mi,   13.1*mi, 110*mi/h, True, dwell_time),
                                # PARK RIDGE stop
    ( 13.1*mi,   14.7*mi, 110*mi/h, True, dwell_time),
                                # DEE ROAD stop
