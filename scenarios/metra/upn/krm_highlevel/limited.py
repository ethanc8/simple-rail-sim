...
route = [
    ...
    (  4.0*mi,   12.0*mi, 70*mi/h, True, dwell_time),
                                # EVANSTON stop
    ( 12.0*mi,   16.6*mi, 70*mi/h, True, dwell_time),
                                # WINNETKA stop
    ( 16.6*mi,   19.2*mi, 70*mi/h, True, dwell_time),
                                # GLENCOE stop
    ( 19.2*mi,   23.0*mi, 70*mi/h, True, dwell_time),
                                # HIGHLAND PARK stop
    ( 23.0*mi,   28.3*mi, 70*mi/h, True, dwell_time),
                                # LAKE FOREST stop
    ( 28.3*mi,   35.9*mi, 70*mi/h, True, dwell_time),
                                # WAUKEGAN stop
    ( 35.9*mi,   51.6*mi, 70*mi/h, True, dwell_time),
                                # KENOSHA stop
    ( 51.6*mi,   61.7*mi, 70*mi/h, True, dwell_time),
                                # RACINE stop
    ( 61.7*mi,   83.0*mi, 70*mi/h, False, dwell_time),
