...
route = [
    ...
    (  1.0*mi,    2.2*mi, 50*mi/h, True, dwell_time),
                                # NORTH AVE stop
    (  2.2*mi,    3.5*mi, 50*mi/h, True, dwell_time),
                                # FULLERTON AVE stop
    (  3.5*mi,    4.0*mi, 50*mi/h, False, dwell_time),
    (  4.0*mi,    4.5*mi, 90*mi/h, True, dwell_time),
                                # BELMONT AVE stop
    (  4.5*mi,    5.5*mi, 90*mi/h, True, dwell_time),
                                # IRVING PARK RD stop
    (  5.5*mi,    6.5*mi, 90*mi/h, True, dwell_time),
                                # RAVENSWOOD stop
    ...
    ( 44.5*mi,   51.6*mi, 90*mi/h, True, 4.5 * 60),
                                # KENOSHA stop
